...
This file mirrors g1_world_output/stream_buffer.py: two containers, no
shared package (spec_1 keeps Layer 1 inside each device node). Keep
behavioral changes in sync manually; tests/test_safety_parity.py guards
the common behavior.
"""
